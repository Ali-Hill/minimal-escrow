...
import Data.Foldable (Foldable (fold, null), sequence_)
import Data.Map (Map)
...
tests :: PTTWrapper Env EscrowModel TestTree
tests =
  testGroup
    "escrow"
    ...
    , checkPredicateOptions
        ...
        $ do
          ...
          E.awaitSlot 100
          act $ Refund 1
    , testPropertyWithOptions "QuickCheck ContractModel" $
        QC.withMaxSuccess 40 . E.propRunActionsWithOptions
    ]
